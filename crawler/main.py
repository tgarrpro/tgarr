...
# Federation swarm validator (v0.4.16+): client pulls seed candidates from
        ...
        try:
            ...
            try:
                req = urllib.request.Request(
                    url,
                    headers={"User-Agent": "tgarr/0.4.16 (+https://tgarr.me)",
            ...
            try:
                req = urllib.request.Request(
                    ...
                    headers={"Content-Type": "application/json",
                             "User-Agent": "tgarr/0.4.16 (+https://tgarr.me)"},
                    method="POST")
                resp = await asyncio.to_thread(
                    lambda: urllib.request.urlopen(req, timeout=30).read())
